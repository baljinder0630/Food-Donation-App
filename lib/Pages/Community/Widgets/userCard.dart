...
class _UserCardState extends ConsumerState<UserCard> {
  ...
  Widget build(BuildContext context) {
    return Container(
      margin: EdgeInsets.only(left: 24.w, right: 24.w, bottom: 10.h, top: 10.h),
      width: 376.w,
      height: 83.h,
              ...
              children: [
                ...
                Center(
                  child: Container(
                    height: 15.h,
                    child: Text(
                      widget.user.totalConnects.toString() + " connects",
                      style: TextStyle(
                        color: Color(0xFF201F24),
                        fontSize: 12.sp,
                        fontFamily: 'Outfit',
            ...
            children: [
              ...
              InkWell(
                onTap: () async {
                  ...
                  context.pushRoute(ChatScreenRoute(TargetUser: widget.user));
                  // } else
                  //   log("Error occured");
                },
                child: Container(
