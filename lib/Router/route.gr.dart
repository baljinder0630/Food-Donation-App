...
abstract class $AppRouter extends _i39.RootStackRouter {
  ...
  final Map<String, _i39.PageFactory> pagesMap = {
    ...
    AcceptPickupRequestPageRoute.name: (routeData) {
      ...
      return _i39.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i23.AcceptPickupRequestPage(
    ...
    DonationDescriptionRoute.name: (routeData) {
      ...
      return _i39.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i24.DonationDescription(
          key: args.key,
...
class AcceptPickupRequestPageRoute
    extends _i39.PageRouteInfo<AcceptPickupRequestPageRouteArgs> {
  ...
  static const _i39.PageInfo<AcceptPickupRequestPageRouteArgs> page =
      _i39.PageInfo<AcceptPickupRequestPageRouteArgs>(name);
}
...
class DonationDescriptionRoute
    extends _i39.PageRouteInfo<DonationDescriptionRouteArgs> {
  DonationDescriptionRoute({
    ...
    required _i43.Timestamp timestamp,
  ...
  static const _i39.PageInfo<DonationDescriptionRouteArgs> page =
      _i39.PageInfo<DonationDescriptionRouteArgs>(name);
}
...
class DonationDescriptionRouteArgs {
  ...
  final _i43.Timestamp timestamp;
  ...
  @override
  String toString() {
    return 'DonationDescriptionRouteArgs{key: $key, requestName: $requestName, NGOName: $NGOName, ngoLatitude: $ngoLatitude, ngoLongitude: $ngoLongitude, totalRequest: $totalRequest, remainingRequest: $remainingRequest, timestamp: $timestamp, description: $description, phoneNumber: $phoneNumber}';
  }
}
